...
public class WordQuery {
    ...
    private static void wordQueryTest(){
        //在请求中添加pretty参数，可以让ES输出为容易阅读的JSON格式数据
        Map<String, String> params = Collections.singletonMap("pretty", "true");

        //	指定输出个数（limit）：加“size : x”
        //	排序(sort)：加"sort" : {"cur_time" : {"order" : "desc"}}

        //命令解释：查询title字段中带有"as" 的文档
       String jsonString = "{\"query\" : { \"match\": { \"title\" : \"as\" }}}";
        //命令解释：查询title字段中带有"as" 的 2 个文档,
    //    String jsonString = "{\"query\" : { \"match\": { \"title\" : \"as\" }},\"size\" : 2 }";
        //命令解释：查询含有”as”的文档，且按照cur_time字段降序排序
    //    String jsonString = "{\"query\" : { \"match\": { \"title\" : \"as\" }},\"sort\" : {\"cur_time\" : {\"order\" : \"desc\"}}}";
