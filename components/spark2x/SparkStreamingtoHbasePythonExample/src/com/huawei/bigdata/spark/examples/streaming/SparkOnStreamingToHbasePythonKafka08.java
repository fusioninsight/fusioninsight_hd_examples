...
public class SparkOnStreamingToHbasePythonKafka08 implements Serializable {
    ...
    public void streamingToHbase(JavaSparkContext jsc, String checkPointDir, String topics, String brokers,
        ...
        JavaPairInputDStream<String, String> messages = KafkaUtils.createDirectStream(jssc, String.class, String.class, StringDecoder.class, StringDecoder.class, kafkaParams, topicSet);
        ...
        hbaseContext.streamBulkPut(lines,
