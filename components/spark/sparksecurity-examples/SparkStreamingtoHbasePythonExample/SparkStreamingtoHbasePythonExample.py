...
if __name__ == "__main__":
	...
	# 向sc._jvm中导入要运行的类
    java_import(sc._jvm, 'com.huawei.bigdata.spark.examples.streaming.SparkStreamingtoHbase')

	# 创建类实例并调用方法
    sc._jvm.SparkStreamingtoHbase().streamingtohbase(sc._jsc, sys.argv[1], sys.argv[2], sys.argv[3])
