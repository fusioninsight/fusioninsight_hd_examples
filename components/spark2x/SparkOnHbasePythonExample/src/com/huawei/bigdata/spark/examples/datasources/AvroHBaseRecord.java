...
public class AvroHBaseRecord{
    ...
    public static AvroHBaseRecord apply(int i){
        ...
        GenericData.Array favoriteArray = new GenericData.Array<String>(2, avroSchema.getField("favorite_array").schema());
    ...
    final static String schemaString =
    ...
    final static Schema avroSchema = new Schema.Parser().parse(schemaString);
