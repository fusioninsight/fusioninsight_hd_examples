...
//         //创建索引表
 //       createTable(index);
         ...
         //向索引中分别插入三个文档
//        String jsonString1 = "{\"content\":\"新中国成立了\"}";
//        String jsonString2 = "{\"content\":\"新疆在中国的西部\"}";
//        String jsonString3 = "{\"content\":\"新疆是个好地方\"}";
//        String jsonString4 = "{\"content\":\"新疆是丝绸之路上的一个重要地点\"}";
//        String jsonString5 = "{\"content\":\"这是一条测试数据\"}";
...
//         //模糊查询
     ...
     private static void fuzzyQuery(){
         ...
         //命令解释：查询title字段中包含”了”的文档
         String jsonString = "{\"query\" : { \"wildcard\" :  { \"content\" : \"*了\"}} }";
     ...
     private static void createTable(String index){
         //*************创建指定分片数目的索引************
         Map<String, String> params = Collections.singletonMap("pretty", "true");
         //在创建index的同时设置分词器类型
         Response rsp = null;
