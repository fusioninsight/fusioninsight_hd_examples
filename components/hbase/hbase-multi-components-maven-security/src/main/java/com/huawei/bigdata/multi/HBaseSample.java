...
public class HBaseSample {
  ...
  public HBaseSample(Configuration conf) throws IOException {
    this.conf = conf;
    this.tableName = TableName.valueOf("example_table");
...
//		int i = 0;
//		while(true){
//			System.out.println("===============begin to check." + i + "===============");
...
//			}
//		}
//		System.out.println("===============finished to check.===================");
 ...
 * @throws Exception 
  ...
  public void testCreateTable() throws Exception {
    ...
    try {
      ...
      LOG.error("Create table failed.", e);
        ...
        LOG.info("table size is :" + tbs.length);
      if (admin != null) {
        try {
  ...
  public void testPut() {
    ...
    try {
      ...
      table.put(puts);//table.setAutoFlushTo(false);      
  ...
  public void testGet() {
    ...
    // Specify RowKey.
    byte[] rowKey = Bytes.toBytes("1406");
