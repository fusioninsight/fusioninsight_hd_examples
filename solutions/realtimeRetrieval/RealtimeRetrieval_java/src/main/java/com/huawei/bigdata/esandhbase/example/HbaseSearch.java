...
public class HbaseSearch {
    ...
    static {
        //日志配置文件
        PropertyConfigurator.configure(HbaseSearch.class.getClassLoader().getResource("conf/log4j.properties").getPath());
    }
    ...
    public static void main(String[] args)
    {
        ...
        conf.addResource(new Path(HbaseSearch.class.getClassLoader().getResource("conf/core-site.xml").getPath()), false);
        conf.addResource(new Path(HbaseSearch.class.getClassLoader().getResource("conf/hdfs-site.xml").getPath()), false);
        conf.addResource(new Path(HbaseSearch.class.getClassLoader().getResource("conf/hbase-site.xml").getPath()), false);
        ...
        try
        {
            ...
            if (User.isHBaseSecurityEnabled(conf))
            {
                ...
                String userKeytabFile = HbaseSearch.class.getClassLoader().getResource("conf/user.keytab").getPath();
                String krb5File = HbaseSearch.class.getClassLoader().getResource("conf/krb5.conf").getPath();
