...
public class FemaleInfoCollection {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String userKeytabPath = "D:/git/HD/components/spark2x/SparkSQLJavaExample/conf/user.keytab";
        String krb5ConfPath = "D:/git/HD/components/spark2x/SparkSQLJavaExample/conf/krb5.conf";
        ...
        JavaRDD<FemaleInfo> femaleInfoJavaRDD = spark.read().textFile("/zwl/test").javaRDD().map(
