...
object ThriftServerQueriesTest {
  def main(args: Array[String]): Unit = {
    ...
    val securityConfig: String = ";saslQop=auth-conf;auth=KERBEROS;principal=spark/hadoop." + principalName + "@" + principalName + ";user.principal=sparkuser;user.keytab=/opt/FIclient/user.keytab;"
