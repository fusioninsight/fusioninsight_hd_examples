...
public class HBaseSample
{
    ...
    public void disableIndex()
    {
        ...
        try
        {
            ...
            System.out.println("Successfully disable indices " + indexNameList + " of the table " + tableName);
        }
        catch (IOException e)
        {
            System.out.println("Failed to disable indices " + indexNameList + " of the table " + tableName + "." + e);
        }
        finally
        {
            if (iAdmin != null)
    ...
    {
        LOG.info("Entering testAggregation.");
        /**
        ...
        try
        {
            ...
            count = aggregationClient.rowCount(table, columnInterpreter, scan);
        ...
        LOG.info("Exiting testAggregation.");
    }
}
