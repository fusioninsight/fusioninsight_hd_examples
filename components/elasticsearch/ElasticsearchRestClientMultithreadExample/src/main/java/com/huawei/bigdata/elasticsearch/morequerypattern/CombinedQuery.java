...
public class CombinedQuery {
    ...
    private static void combinedQuery(){
        ...
        //命令解释：查询title字段中包含”minimum”、不包含”existence”文档、包含”allowed”或者”phases”的文档
        String jsonString =
                "{\"query\" : { \"bool\" : { \"must\" : { \"match\": { \"title\" : \"minimum\" }}," +
                                            "\"must_not\" : { \"match\" : {\"title\" : \"existence\"}}, " +
                                             "\"should\" : [ { \"match\" : { \"title\" : \"allowed\"}}," +
                                                              "{ \"match\" : { \"title\" : \"phases\"}}]}} }";
