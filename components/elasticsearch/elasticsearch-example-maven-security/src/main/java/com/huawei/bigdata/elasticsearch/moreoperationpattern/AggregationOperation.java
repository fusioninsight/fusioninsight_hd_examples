...
//        //向索引中分别插入三个文档
//        String jsonString1 = "{\"first_name\" : \"john\", \"last_name\" : \"smith\", \"interest\" : \"tea\"}";
//        String jsonString2 = "{\"first_name\" : \"jr\", \"last_name\" : \"smith\", \"interest\" : \"sports\"}";
//        String jsonString3 = "{\"first_name\" : \"larry\", \"last_name\" : \"smith\", \"interest\" : \"sports\"}";
//        String jsonString4 = "{\"first_name\" : \"lebron\", \"last_name\" : \"smith\", \"interest\" : \"rest\"}";
//        String jsonString5 = "{\"first_name\" : \"lebron\", \"last_name\" : \"james\", \"interest\" : \"tea\"}";
//
//        postTestData(index,jsonString1);
//        postTestData(index,jsonString2);
//        postTestData(index,jsonString3);
//        postTestData(index,jsonString4);
//        postTestData(index,jsonString5);
////
////        //聚合操作
...
////        //删除表
 //       deleteTabel();
    ...
    private static void aggregationOperation(){
        //在请求中添加pretty参数，可以让ES输出为容易阅读的JSON格式数据
        Map<String, String> params = Collections.singletonMap("pretty", "true");

        //命令解释：对test_aggs表中所有文档进行”interest”字段的聚合
        // {"first_name" : "lebron", "last_name" : "james", "interest" : "tea"}'
        String jsonString = "{\"aggs\" : {\"all_interest\" : { \"terms\" : {\"field\" : \"interest.keyword\"}}}}";

        //命令解释：对test_aggs表中”last_name”字段含有”smith”的文档进行”interest”字段的聚合
        // { "query" : {"match" : {"last_name" : "smith"}}, "aggs" : {"all_interest" : { "terms" : {"field" : "interest.keyword"}}}}'
        // String jsonString = "{ \"query\" : {\"match\" : {\"last_name\" : \"smith\"}}, \"aggs\" : {\"all_interest\" : { \"terms\" : {\"field\" : \"interest.keyword\"}}}}";
        HttpEntity entity = new NStringEntity(jsonString, ContentType.APPLICATION_JSON);
        Response rsp = null;
        try {
