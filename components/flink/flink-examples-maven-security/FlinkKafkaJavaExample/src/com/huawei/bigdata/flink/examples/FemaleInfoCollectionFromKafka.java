...
public class FemaleInfoCollectionFromKafka
{
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println("./bin/flink run --class com.huawei.bigdata.flink.examples.FemaleInfoCollectionFromKafka" + " /opt/test.jar --windowTime 2 --topic topic-test --bootstrap.servers 9.91.8.218:21005");
        System.out.println("./bin/flink run --class com.huawei.bigdata.flink.examples.FemaleInfoCollectionFromKafka" + " /opt/test.jar --windowTime 2 --topic topic-test --bootstrap.servers 9.91.8.218:21007 --security.protocol SASL_PLAINTEXT --sasl.kerberos.service.name kafka");
        System.out.println("./bin/flink run --class com.huawei.bigdata.flink.examples.FemaleInfoCollectionFromKafka" + " /opt/test.jar --windowTime 2 --topic topic-test --bootstrap.servers 9.91.8.218:21008 --security.protocol SSL --ssl.truststore.location /home/truststore.jks --ssl.truststore.password huawei");
        System.out.println("./bin/flink run --class com.huawei.bigdata.flink.examples.FemaleInfoCollectionFromKafka" + " /opt/test.jar --windowTime 2 --topic topic-test --bootstrap.servers 9.91.8.218:21009 --security.protocol SASL_SSL --sasl.kerberos.service.name kafka --ssl.truststore.location /home/truststore.jks --ssl.truststore.password huawei");
        System.out.println("******************************************************************************************");
    ...
    public static class UserRecord
    {
        ...
        public UserRecord(String n, String s, Integer t)
        {
            name = n;
            sexy = s;
            shoppingTime = t;
