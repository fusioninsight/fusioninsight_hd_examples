 ...
 */
package com.huawei.bigdata.solr.examples;
...
{
    {
        PropertyConfigurator.configure(TestSample.class.getClassLoader().getResource("conf/log4j.properties").getPath());
    }
    ...
    private void initProperties() throws SolrException
    {
        ...
        String proPath = TestSample.class.getClassLoader().getResource("conf/solr-example.properties").getPath(); 
        ...
        sharedFsReplication = properties.getProperty("sharedFsReplication") == null ? null
    ...
    {
        String keytabPath = TestSample.class.getClassLoader().getResource("conf/user.keytab").getPath();
        String krb5Path = TestSample.class.getClassLoader().getResource("conf/krb5.conf").getPath();
        try
        {
