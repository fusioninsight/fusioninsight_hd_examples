...
public class ASparkStreamingDemoForDoc {
    public static void main(String[] args) throws Exception
    {
        ...
        LoginUtil.login("lyysxg", keyTab, krb5Conf, hadoopConf);
        //******认证 End********
        ...
        //运行程序前，先在187.7.67.6主机上执行nc -lk 9999，启动console的输入，通过键盘输入，作为输入流。
        //创建以socket数据流作为输入来源的DStream
        JavaDStream<String> lines = javaStreamingContext.socketTextStream("189.154.5.75", 9999);
